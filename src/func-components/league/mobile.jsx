...
const CompetitionBlock = ({
  ...
  return (
    <Spin spinning={loading}>
      {/* competition list */}
      <div className={cls(styles.competition_list, isEmpty ? styles.empty_list : null, keyword ? styles.without_menu : null)}>
        {/* 无数据展示 */}
...
const League = React.memo(({ visible, onClose = () => {}, onSubmit = () => {} }) => {
  ...
  const [selectedIds, setSelectedIds] = useState(getSessionStorage(SESS_STORAGE_SELECTED_LEAGUES, []));
    ...
    <div className={cls(styles.league, visible ? styles.show : null)}>
      ...
      <div className={styles.content}>
        ...
        <Tabs
          ...
          tabBarStyle={{ margin: 0, height: 46 / 3.75 + 'vw', fontSize: 14 / 3.75 + 'vw' }}
        >
          <Tabs.TabPane
